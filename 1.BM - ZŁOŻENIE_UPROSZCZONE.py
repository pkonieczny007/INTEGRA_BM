...
def generate_zlozenie_xml(data, mapping, output_file="output_zlozenie_BM.xml"):
    ...
    # Szablon XML dla typu "BM_ZŁOŻENIE"
    assembly_template = [
...
def generate_z_bazy_xml(data, output_file="output_z_bazy_do_zlozen.xml"):
    ...
    Uwaga: Zakładamy, że w pliku Excel występują kolumny "BM_ZŁOŻENIE", "BM_REFERENCJA"
